          ...
          {FEATURED_PROJECTS.map((project, idx) => (
            ...
            >
              ...
              <div className="relative bg-white/5 backdrop-blur-xl rounded-[24px] border border-white/10 overflow-hidden flex flex-col h-full hover:border-white/20 transition-all shadow-xl">
                {/* Tech Header */}
                <div className="relative h-32 sm:h-40 w-full bg-gradient-to-br from-accent/20 to-accent/5 flex items-center justify-center overflow-hidden">
                ...
                <div className="p-4 sm:p-6 flex flex-col gap-3 sm:gap-4 flex-1">
                  <div className="min-w-0">
                    <h3 className="text-lg sm:text-xl font-semibold text-white group-hover:text-accent transition-colors mb-1 truncate">
                      {project.title}
                    </h3>
                  ...
                  <ul className="space-y-2 text-xs sm:text-sm text-white/70 flex-1">
